	...
	default:
		...
		case '/': // Prefix: "/people"
			...
			if len(elem) == 0 {
				switch r.Method {
				case "GET":
					s.handleListPersonRequest([0]string{}, w, r)
				case "POST":
					s.handleCreatePersonRequest([0]string{}, w, r)
				default:
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						s.handleReadPersonRequest([1]string{
							args[0],
						}, w, r)
					case "PATCH":
