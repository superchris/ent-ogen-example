...
func decodeDeletePersonParams(args [1]string, r *http.Request) (params DeletePersonParams, _ error) {
	// Decode path: id.
	if err := func() error {
...
// ListPersonParams is parameters of listPerson operation.
...
func unpackListPersonParams(packed middleware.Parameters) (params ListPersonParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
...
func decodeListPersonParams(args [0]string, r *http.Request) (params ListPersonParams, _ error) {
...
func unpackReadPersonParams(packed middleware.Parameters) (params ReadPersonParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeReadPersonParams(args [1]string, r *http.Request) (params ReadPersonParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param, err := url.PathUnescape(args[0])
		if err != nil {
...
func decodeUpdatePersonParams(args [1]string, r *http.Request) (params UpdatePersonParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param, err := url.PathUnescape(args[0])
		if err != nil {
